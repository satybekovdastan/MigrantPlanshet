...
import com.migrate.admin.pagination.Activities.SecondActivities.ProhibitionSecondActivity;
...
db();
    ...
    public void onClickButton(View view) {
        startActivity(new Intent(ProhibitionRFActivity.this, ProhibitionSecondActivity.class));
    }
